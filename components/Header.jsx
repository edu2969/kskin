        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="w-full mx-auto mb-4">
                <div className="w-full flex justify-center">
                    ...
                    <div className={`flex space-x-6 mt-4 ${scrolled ? 'text-black' : 'text-[#696968]'} text-lg`}>
                        ...
                        <Link className='text-lg p-0 text-current' href="/admin">
                        {session?.user ? <Image src={session.user.avatarImg} alt="user" width={32} height={32} className="rounded-full -mt-1" /> : <p className="hover:text-black hover:underline cursor-pointer uppercase tracking-widest">Ingresar</p>}                            
                        </Link> 
                    </div>
                </div>
            </div>
